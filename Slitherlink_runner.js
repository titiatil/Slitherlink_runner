...
function initializeBoard_normal() {
    ...
    for (let i = 0; i < 50000; i++) {
        ...
        const y = Math.floor(Math.random() * (T[0].length - 9) + 10);
...
function visualize_board(masume_tate, masume_yoko,
    ...
    for (let y = 0; y < masume_tate; y++) {
        for (let x = passed_mass_x*2; x < passed_mass_x * 2 + 35 * 2; x++) {
            if (y + 1 < masume_tate) {
                if (Board[y][x] != -1) {
...
function keydownfunc(event) {
    ...
    if (game.status === 1) {
        ...
        // 上下左右について
        if (key_code === 39 && !(keysPressing[40]) && !(keysPressing[38]) ) {//　右のみを押したとき
            if (one_game.my_x + 1 < one_game.masume_yoko && one_game.Used[one_game.my_y][one_game.my_x + 1] === 0) {
                ...
                if (one_game.my_y % 2 === 0){
                    if (one_game.my_y - 1 >= 0) {
                        ...
                        console.log([one_game.Board2[one_game.my_y - 1][(one_game.my_x - 1)*2],one_game.Board[one_game.my_y - 1][(one_game.my_x - 1)*2]])
                    }
                    if (one_game.my_y < one_game.masume_tate - 1) {
                        one_game.Board2[one_game.my_y][(one_game.my_x - 1)*2] += 1;
                        console.log([one_game.Board2[one_game.my_y][(one_game.my_x - 1)*2],one_game.Board[one_game.my_y][(one_game.my_x - 1)*2]])
                    }
                }
                else{
                    if (one_game.my_y - 1 >= 0) {
                        one_game.Board2[one_game.my_y - 1][one_game.my_x*2 - 1] += 1;
                        console.log([one_game.Board2[one_game.my_y - 1][one_game.my_x*2 - 1],one_game.Board[one_game.my_y - 1][one_game.my_x*2 - 1]])
                    }
                    if (one_game.my_y < one_game.masume_tate - 1) {
                        one_game.Board2[one_game.my_y][one_game.my_x*2 - 1] += 1;
                        console.log([one_game.Board2[one_game.my_y][one_game.my_x*2 - 1],one_game.Board[one_game.my_y][one_game.my_x*2 - 1]])
                    }
                }
            }
        ...
        else if (key_code === 37 && !(keysPressing[40]) && !(keysPressing[38]) ) {// 左のみを押したとき
        ...
        else if ((key_code === 39 && (keysPressing[38]) && !(keysPressing[40]))||(key_code === 38 && (keysPressing[39]) && !(keysPressing[37])) ){ //右上
            if (one_game.my_y % 2 === 0){
        ...
        else if ((key_code === 39 && (keysPressing[40]) && !(keysPressing[38]))||(key_code === 40 && (keysPressing[39]) && !(keysPressing[37])) ){ //右下
            if (one_game.my_y % 2 === 0){
        ...
        else if ((key_code === 37 && (keysPressing[38]) && !(keysPressing[40]))||(key_code === 38 && (keysPressing[37]) && !(keysPressing[39])) ){ //左上
            if (one_game.my_y % 2 === 0){
        ...
        else if ((key_code === 37 && (keysPressing[40]) && !(keysPressing[38]))||(key_code === 40 && (keysPressing[37]) && !(keysPressing[39])) ){ //左下
            if (one_game.my_y % 2 === 0){
...
function visual() {
    ...
    if (((one_game.my_y % 2 === 0) && (one_game.my_x * game.mass - one_game.passedtime < -game.radius * 2))||(((one_game.my_y % 2 === 1) && (one_game.my_x * game.mass - one_game.passedtime < -game.radius * 2 - game.mass/2)))) {
        ...
        if (one_game.passedtime > (one_game.masume_yoko - 2) * game.mass/2) {
